...
function staffDirectoryClick() {
  ...
  const staffDirectoryOpener = document.querySelector('.staffDirectory-filter__btn');
...
const checkboxes = document.querySelectorAll(".staffDirectory-category input[type='checkbox']");
